...
class Statistics {
    ...
    render(title, box){
        ...
        y += 40;
        stats.push(game.screen.text(x1 + indent, y,"TNT COLLECTED:").attr(attrStatLeft));
        stats.push(game.screen.text(x2, y, numberWithCommas(this.tntCollected)).attr(attrStatRight));
